...
st.set_page_config(page_title="SOLA ROOF — Cost Estimator", page_icon="🏠", layout="wide")
...
st.link_button("▶ View the animated showcase", "https://dvdlkj-glitch.github.io/sola-roof-website/")
